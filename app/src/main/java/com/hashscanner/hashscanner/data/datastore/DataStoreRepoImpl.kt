package com.hashscanner.hashscanner.data.datastore
...
import com.hashscanner.hashscanner.utils.Constants.DATASTORE_NAME
...
class DataStoreRepoImpl @Inject constructor(@param:ApplicationContext private val context: Context) : DataStoreRepo {
